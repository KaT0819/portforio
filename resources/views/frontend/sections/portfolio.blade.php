    ...
    <div class="row">
      <div class="col-lg-6 offset-lg-3 text-center">
        <div class="section-title">
          <h3 class="title">最新のポートフォリオ</h3>
          <div class="desc">
            <p>私たちの最新のプロジェクトをご覧ください。デザインと開発の革新をお届けします。</p>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-12">
        <ul class="filter-menu">
          <li class="active" data-filter="*">すべてのプロジェクト</li>
          <li data-filter=".branding">ブランディングデザイン</li>
          <li data-filter=".interface">ユーザーインターフェース</li>
          <li data-filter=".experience">ユーザーエクスペリエンス</li>
          <li data-filter=".development">ウェブ開発</li>
        </ul>
      </div>
    </div>
